...
const BurgerOrder = () => {
    ...
    useEffect(() => {
        ...
        if (show) {
            ...
            getOrderNumber(orderData).then(data => {
                setOrderNumber(data)
            }).then( setMessage(`идентификатор заказа
    ...
    return (
        <div className={`${Styles.currency}  `}>
            ...
            <div className={`${Styles.order_button} `} >
                ...
                <Button type="primary" size="large" onClick={() => { setShow(true); setMessage('Приступили к работе ...')}}>Оформить заказ</Button>
