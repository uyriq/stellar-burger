    ...
    return (
        <div className={` ${Style.box} `}>
            <div className={` ${Style.div1} `}>
                <img
                    srcSet={` ${props.image_mobile} .2x,  ${props.image} 0.5x, ${props.image_large} 1x `}
                    alt={props.name}
            ...
            <div className={` ${Style.div4}   text_type_digits-default text_color_inactive  `}>
                {' '}
                {`${props.calories}`}{' '}
            </div>
            <div className={` ${Style.div5}   text_color_inactive text_type_main-small  `}> Белки, г </div>
            <div className={` ${Style.div6}   text_type_digits-default text_color_inactive  `}>
                {' '}
                {`${props.proteins}`}{' '}
            </div>
