...
function OrderConfirm({ numero: Number, message }) {
    ...
    return (
        <div className={` ${Style.order_card} `}>
            ...
            <div className={` ${Style.n4}  text  text_type_main-default `}>
                {messageArr[1]}
            </div>
            <div
                className={` ${Style.n5}  text text_type_main-default  text_color_inactive `}
            >
                {messageArr[2]}
            </div>
            <div
                className={` ${Style.n6}  text text_type_main-default  text_color_inactive `}
            >
                {messageArr[3]}
            </div>
        </div>
